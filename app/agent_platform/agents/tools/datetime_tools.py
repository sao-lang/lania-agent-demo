...
from app.agent_platform.capabilities.datetime import DateTimeCapability
...
class GetDateInfoInput(BaseModel):
    """获取日期信息的输入参数�?""
    date_str: str = Field(default='', description='日期字符串（�?"2026-07-04"），为空则返回今�?)
