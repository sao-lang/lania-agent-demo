...
class GetStockQuoteInput(BaseModel):
    """获取股票行情的输入参数�?""
    symbol: str = Field(description='股票代码，支�?sh600519 / 600519 / AAPL / US.AAPL 等格�?)
...
class GetHistoricalPricesInput(BaseModel):
    ...
    period: str = Field(default='1mo', description='周期�?d / 1mo / 3mo / 6mo / 1y')
